            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link href="/" className="flex h-full items-center gap-x-3 px-12 justify-center">
                ...
                <hr className="my-6 border-rose-200 sm:mx-auto dark:border-rose-700 lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-rose-500 sm:text-center dark:text-rose-400">© 2024 <a href="" className="hover:underline">Đi đâu đây™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="https://www.facebook.com/didaudayproject/">
                            <Image src="/facebook.svg" alt="Di Dau Day" height={24} width={24} />
                        </a>
                        <a href="https://www.instagram.com/didauday.project/" className="ml-4">
                            <Image src="/instagram.svg" alt="Di Dau Day" height={24} width={24} />
